...
CREATE TABLE IF NOT EXISTS commentaires (
    ...
    comment_text VARCHAR(500) NULL COMMENT 'Texte du commentaire (NULL si commentaire vocal)',
    comment_audio_url LONGTEXT NULL COMMENT 'URL du fichier audio (commentaire vocal)',
    comment_duration INT NULL COMMENT 'Durée de l\'audio en secondes',
